...
"	Decho "(ManPageView) multimanpage: mapping PageUp/Down to go to ctrl-f, ctrl-b"
...
"	 Decho "(ManPageView) ‣s:iconv<".(exists("s:iconv")? s:iconv : 'n/a').">"
"	 call Decho('(ManPageView) ‣s:nostderr="'.s:nostderr.'"')
	 if exists("g:mpvcmd")
"	  Decho "(ManPageView) ‣mpvcmd: exe ".cmdmod."r!".pgm." ".iopt." ".mpb." ".g:mpvcmd.s:nostderr
      exe cmdmod."r!".pgm." ".iopt." ".mpb." ".g:mpvcmd.s:nostderr
	  unlet g:mpvcmd
	 elseif nospace
"	  Decho "(ManPageView) ‣nospace=".nospace.":  exe sil! ".cmdmod."r!".pgm.iopt.mpb.topic.(exists("s:iconv")? s:iconv : "").s:nostderr
	  exe cmdmod."r!".pgm.iopt.mpb.shellescape(topic,1).(exists("s:iconv")? s:iconv : "").s:nostderr
     elseif has("win32")
"	  Decho "(ManPageView) ‣win32: exe ".cmdmod."r!".pgm." ".iopt." ".mpb." \"".topic."\" ".(exists("s:iconv")? s:iconv : "").s:nostderr
	  exe cmdmod."r!".pgm." ".iopt." ".mpb." ".shellescape(topic,1).(exists("s:iconv")? " ".s:iconv : "").s:nostderr
	 else
